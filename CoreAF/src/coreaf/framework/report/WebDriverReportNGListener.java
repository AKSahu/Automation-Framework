 ...
 *         listener="org.uncommons.reportng.HTMLReporter,org.uncommons.reportng.JUnitXMLReporter,com.pramati.core.util.WebDriverReportNGListener">
 * </pre>
 * 
 * @author A. K. Sahu
 */
public class WebDriverReportNGListener extends TestListenerAdapter {

	private int count = 0;
	private static Logger log = Logger
			.getLogger(WebDriverReportNGListener.class);
